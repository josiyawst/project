                    ...
                    <div class="tab-pane active" id="tab_0">
                        <div class="portlet box green">
                            ...
                            <div class="portlet-body form locations">
                                {!! Form::open(['url' => '/cwadmin/video/update', 'id' => 'EditForm', 'name' => 'EditForm','class' => 'form-horizontal form-row-seperated', 'files' => true, 'method' => 'post','enctype' => 'multipart/form-data']) !!}
