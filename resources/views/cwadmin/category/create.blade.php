                    ...
                    <div class="tab-pane active" id="tab_0">
                        <div class="portlet box green">
                            ...
                            <div class="portlet-body form">
                                {!! Form::open(['url' => '/cwadmin/category/store', 'id' => 'AddForm', 'name' => 'AddForm','class' => 'form-horizontal form-row-seperated', 'files' => true, 'method' => 'post','enctype' => 'multipart/form-data']) !!}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group form-md-line-input">
                                                <label for="parent_id" class="col-md-12">
                                                    Select Parent
                                                    <span class="required">
                                                    *
                                                </span>
            ...
            var FormValidation = function () {
                var r = function () {
                    ...
                    e.validate({
                        ...
                        messages: {
                            parent_id: {
                                required: "Please enter name.", regextitle: "Please select parent."
                            },
                            category: {
